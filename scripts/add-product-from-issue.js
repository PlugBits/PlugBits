...
function main(){
  ...
  const item = {
    ...
    purchase_url_ja: pick('purchase_url_ja'),
    purchase_url_ja_jpy: pick('purchase_url_ja_jpy'),
    purchase_url_ja_usd: pick('purchase_url_ja_usd'),
    purchase_url_en: pick('purchase_url_en'),
    purchase_url_en_jpy: pick('purchase_url_en_jpy'),
    purchase_url_en_usd: pick('purchase_url_en_usd'),
